...
train<-h2o.uploadFile("train_extended_f_2_c.csv",destination_frame = "train.hex")
...
predictors<-c("Agencia_ID","Canal_ID","Ruta_SAK","Cliente_ID","Producto_ID","weight","wtpcs","lag_3")
